...
const BasicHeading4 = (props: typographyType) => <h3 className={(styles.typography, styles.typography_h4)}>{props.text}</h3>;
const BasicHeading5 = (props: typographyType) => <h3 className={(styles.typography, styles.typography_h5)}>{props.text}</h3>;
